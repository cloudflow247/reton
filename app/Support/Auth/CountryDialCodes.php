...
/**
 * ISO 3166-1 alpha-2 → E.164 dial code helpers for registration phone capture.
 */
final class CountryDialCodes
{
    /**
    ...
    public static function toE164(string $dialCode, string $nationalNumber): string
    {
        $dial = preg_replace('/\D+/', '', $dialCode) ?? '';
