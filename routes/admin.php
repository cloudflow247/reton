...
use App\Http\Controllers\Web\Admin\AdminCallbacksController;
use App\Http\Controllers\Web\Admin\AdminDashboardController;
use App\Http\Controllers\Web\Admin\AdminFraudController;
use App\Http\Controllers\Web\Admin\AdminIntegrationsController;
use App\Http\Controllers\Web\Admin\AdminMoneyController;
use App\Http\Controllers\Web\Admin\AdminPlatformSettingsController;
use App\Http\Controllers\Web\Admin\AdminRecoveriesController;
use App\Http\Controllers\Web\Admin\AdminSiteSettingsController;
use App\Http\Controllers\Web\Admin\AdminSupportController;
...
Route::middleware('throttle:60,1')->group(function (): void {
    ...
    Route::post('/fraud/{alert}/resolve', [AdminFraudController::class, 'resolve'])->name('fraud.resolve');

    Route::get('/callbacks', [AdminCallbacksController::class, 'index'])->name('callbacks');
    Route::post('/callbacks/{callback}/resolve', [AdminCallbacksController::class, 'resolve'])->name('callbacks.resolve');

    Route::get('/recoveries', [AdminRecoveriesController::class, 'index'])->name('recoveries');
    Route::post('/recoveries/{recovery}/resolve', [AdminRecoveriesController::class, 'resolve'])->name('recoveries.resolve');

    Route::get('/money', [AdminMoneyController::class, 'index'])->name('money');
