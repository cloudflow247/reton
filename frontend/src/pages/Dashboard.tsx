  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <div className="mt-3 font-num text-5xl font-bold text-white">
          {isLoading ? '—' : ngn(balance)}
        </div>
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <Action to="/send?tab=protection" label="Protection" Icon={ShieldIcon} accent />
      </div>

      <div className="flex items-center justify-between">
        <h2 className="font-display text-lg font-semibold">Recent activity</h2>
        <Link to="/activity" className="text-sm text-mint hover:underline">
          See all
        </Link>
      </div>
