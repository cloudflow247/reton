    ...
    >
      ...
      <div className="relative flex items-center justify-between gap-2">
        <div>
          ...
          <p className="mt-0.5 text-xs text-white/50">Settled balance · ALAT by Wema</p>
        </div>
        <Button
          type="button"
          variant="ghost"
      ...
      {wallet?.account_number && (
        <button
          ...
          className="relative mt-4 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3.5 py-2 text-xs backdrop-blur transition hover:bg-white/20"
        >
          <span className="text-white/55">Account</span>
          <span className="font-num tracking-wider">{wallet.account_number}</span>
